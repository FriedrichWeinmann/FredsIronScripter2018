...
Remove-Module FredsIronScripter2018 -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\FredsIronScripter2018.psd1"
Import-Module "$PSScriptRoot\..\FredsIronScripter2018.psm1" -Force
